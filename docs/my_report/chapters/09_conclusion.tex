...
\begin{enumerate}
  ...
  \item \textbf{Power and energy characterisation.} The final Quartus
        Power Analyser run reported an indicative total thermal power of
        658.31\,mW for \texttt{soc\_top}, but with low tool confidence
        because no user-supplied toggle-rate data was provided.
        Instrumenting the DE1-SoC rails or re-running Power Analyser
        with simulation-derived toggle files would replace this
        indicative figure with a defensible energy-efficiency result,
        which is the metric that matters most in the embedded and edge
        contexts for which this class of accelerator is targeted.
\end{enumerate}
