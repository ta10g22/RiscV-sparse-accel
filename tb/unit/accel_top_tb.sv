...
module accel_top_tb;
  ...
  task automatic test_mmio_regs();
    ...
    drv.mmio_write(CTRL_OFFSET, 32'h0000_000C);
  ...
  task automatic test_simple_spmm();
    ...
    ram_poke(32'h204 >> 2, 32'd1);
    ram_poke(32'h300 >> 2, 32'd2);
    ram_poke(32'h304 >> 2, 32'd3);
